...
async function initDatabase() {
  if (dbType === 'mysql') {
    ...
    // Table 4: stress_test_flows (Dynamic Project-Scoped Transaction Flows)
    await query(`
      CREATE TABLE IF NOT EXISTS stress_test_flows (
        id VARCHAR(64) PRIMARY KEY,
  ...
  await client.query(`
    ...
    CREATE INDEX IF NOT EXISTS idx_flow_project ON stress_test_flows (project_id);
  `);
