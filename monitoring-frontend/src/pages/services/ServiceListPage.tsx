                  ...
                  filteredServices.map((service) => {
                    ...
                    return (
                      <React.Fragment key={service.id}>
                        ...
                        >
                          {/* EXPAND TOGGLE ICON */}
                          <td className="py-3.5 px-3 text-center text-cyan-500 font-bold">
                            {isExpanded ? (
                          ...
                          <td className="py-3.5 px-4 text-center">
                            <div className="flex items-center justify-center gap-1.5" onClick={(e) => e.stopPropagation()}>
                              ...
                              <button
                                ...
                                className="p-1 rounded-lg bg-slate-100 dark:bg-slate-800/80 hover:bg-cyan-500 hover:text-white text-slate-500 dark:text-slate-400 transition"
                              >
